...
<div class="guide">
    ...
    <div class="year-title">
        ...
        <span class="cur-month"><?=$hyear?>년 (<?=$fday->hganji?>) <?=$month?>월 (<?=$tune->hmonth?>)</span>
    ...
    <div class="calendar">
        ...
        <div id="context">
            ...
            <a href="http://afnmp3.homeip.net/~kohyc/calendar/index.cgi">http://afnmp3.homeip.net/~kohyc/calendar/index.cgi</a><br>
